...
class service_container_prod extends \Drupal\Core\DependencyInjection\Container
{
    ...
    {
        $this->services['authentication.cookie'] = $instance = new \Drupal\Core\Authentication\Provider\Cookie($this->get('session_configuration'));
    ...
    {
        $this->services['cache_contexts'] = $instance = new \Drupal\Core\Cache\CacheContexts($this, array(0 => 'cookies', 1 => 'headers', 2 => 'ip', 3 => 'languages', 4 => 'request_format', 5 => 'route', 6 => 'route.menu_active_trails', 7 => 'route.name', 8 => 'theme', 9 => 'timezone', 10 => 'url', 11 => 'url.host', 12 => 'url.query_args', 13 => 'url.query_args.pagers', 14 => 'user', 15 => 'user.is_super_user', 16 => 'user.node_grants', 17 => 'user.roles'));
    ...
    {
        $this->services['http_middleware.page_cache'] = $instance = new \Drupal\Core\StackMiddleware\PageCache($this->get('http_middleware.kernel_pre_handle'), $this->get('cache.render'), $this->get('page_cache_request_policy'), $this->get('page_cache_response_policy'));
    ...
    {
        $this->services['language.default'] = $instance = new \Drupal\Core\Language\LanguageDefault(array('uuid' => '0eacd3a1-3175-4320-8109-097836a794a5', 'langcode' => 'en', 'status' => true, 'dependencies' => array(), 'id' => 'ru', 'label' => 'Russian', 'direction' => 'ltr', 'weight' => 0, 'locked' => false));
    ...
    {
        $this->services['main_content_renderer.html'] = $instance = new \Drupal\Core\Render\MainContent\HtmlRenderer($this->get('title_resolver'), $this->get('plugin.manager.display_variant'), $this->get('event_dispatcher'), $this->get('module_handler'), $this->get('renderer'), $this->get('cache_contexts'));
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'language.default_values' => array(
                'uuid' => '0eacd3a1-3175-4320-8109-097836a794a5',
                'langcode' => 'en',
                'status' => true,
                'dependencies' => array(
...
class Drupal_Core_Config_ConfigInstaller_Proxy implements \Drupal\Core\Config\ConfigInstallerInterface
{
    ...
    public function installOptionalConfig(\Drupal\Core\Config\StorageInterface $storage = NULL, $prefix = '')
    {
        return $this->lazyLoadItself()->installOptionalConfig($storage, $prefix);
    }
